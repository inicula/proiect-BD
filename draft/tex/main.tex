...
\item \textbf{COUNTRY}:
        \begin{m_itemize}
                ...
                \item \emph{name}: \str\footnote{Toate atributele de tip \emph{șir de caractere} vor avea lungimea maximă egală cu 50.} care reprezintă numele țării.
        \end{m_itemize}
...
\begin{itemize}[label=\textbullet, noitemsep, topsep=0pt, after=]
        ...
        \begin{m_itemize}
                \item Realizează trei legături independente: identifică categoriile la care un client este abonat, identifică angajații care i-au făcut cel puțin un abonament clientului, identifică angajații care pot face abonamente pentru o anumită categorie.
                \item Are cardinalitatea \texttt{M(0):M(0):M(0)}.
        \end{m_itemize}
